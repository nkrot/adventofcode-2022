...
class Node(object):
    ...
    def as_tree(self):
        ...
        lines = [_self] + [ch.as_tree() for ch in self.children]
        return "\n".join(lines)
...
tests = [
    (utils.load_input('test.1.txt'), 94853 + 584, 24933642),
]


reals = [
    (utils.load_input(), 1454188, 4183246)
]
